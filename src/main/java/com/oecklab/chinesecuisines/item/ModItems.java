...
public class ModItems {
    ...
    private static Item registerItem(String name, Item item) {
        return Registry.register(Registries.ITEM, new Identifier(ChineseCuisines.MOD_ID, name), item);
    }

    public static void registerModItems() {
        ChineseCuisines.LOGGER.info("Registering Mod Items for" + ChineseCuisines.MOD_ID);
